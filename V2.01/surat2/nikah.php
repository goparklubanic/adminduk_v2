...
$section->writeText("<u>SURAT KETERANGAN NIKAH</u>",$fontdef,$kop);
...
//ttl
$wrga->writeToCell(2,1,'Tempat Tanggal Lahir');
$wrga->writeToCell(2,2,':');
$wrga->writeToCell(2,3,ufirst($warga['tp_lahir'].", ".$warga['tg_lahir']));

//kelamin
$wrga->writeToCell(3,1,'Jenis Kelamin');
$wrga->writeToCell(3,2,':');
$wrga->writeToCell(3,3,$warga['kelamin']);

//kewarganegaraan
$wrga->writeToCell(4,1,'Kewarganegaraan');
$wrga->writeToCell(4,2,':');
$wrga->writeToCell(4,3,ufirst($warga['kewarganegaraan']));

//agama
$wrga->writeToCell(5,1,'Agama');
$wrga->writeToCell(5,2,':');
$wrga->writeToCell(5,3,ufirst($warga['agama']));

//alamat
$wrga->writeToCell(6,1,'Tempat Tinggal');
$wrga->writeToCell(6,2,':');
$wrga->writeToCell(6,3,ufirst(desa).", RT. :".$warga['rt']." RW. :".$warga['rw']);

$section->writeText("Orang tersebut di atas adalah benar-benar Penduduk Kelurahan Rejasa dan berstatus <b>".ufirst($warga['st_kawin'])."</b>.",$fontdef,$badan);
...
$rtf->save('./rtf/nikah.rtf');

echo "
<a href='./rtf/nikah.rtf'>Unduh Surat</a>
";
