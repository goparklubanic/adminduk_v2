...
$section->writeText("<u>SURAT KETERANGAN USAHA</u>",$fontdef,$kop);
...
//alamat
$wrga->writeToCell(3,1,'Tempat Tinggal');
$wrga->writeToCell(3,2,':');
$wrga->writeToCell(3,3,ufirst(desa).', RT. '.$warga['rt'].' RW. '.$warga['rw']);

//anak
$section->writeTExt("Orang tersebut di atas memiliki usaha:",$fontdef,$badan);
...
//nama
$dtan->writeToCell(1,1,'Jenis usaha');
$dtan->writeToCell(1,2,':');
$dtan->writeToCell(1,3,ufirst($data[4]));
//ttl
$dtan->writeToCell(2,1,'Jenis Barang Dagangan');
$dtan->writeToCell(2,2,':');
$dtan->writeToCell(2,3,ufirst($data[5]));
//alamat
$dtan->writeToCell(3,1,'Mulai');
$dtan->writeToCell(3,2,':');
$dtan->writeToCell(3,3,'Tahun '.$data[6]);
...
$rtf->save('./rtf/usaha.rtf');

echo "
<a href='./rtf/usaha.rtf'>Unduh Surat</a>
";
