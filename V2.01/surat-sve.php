...
if($sk=="ket"){
	$datask=array($_POST['no_klas'],$_POST['nobuku'],$_POST['tgs'], $_POST['nik'],
...
if($sk=="skm"){
	$datask=array($_POST['no_klas'], $_POST['nobuku'], $_POST['tgs'], 
...
if($sk=="lhr"){
	$datask=array($_POST['no_klas'], $_POST['nobuku'], $_POST['tgs'],$_POST['nkk'], $_POST['bynama'], 
...
if($sk=="wft"){
	...
	$datask=array($_POST['no_klas'],$_POST['nobuku'], $_POST['tgs'],$_POST['nkk'], 
...
$surat->saveAgenda($_POST['no_klas'],$_POST['tgs'],$_POST['nik'],$_POST['ttd'],$sk,$_POST['buku'],$_POST['nobuku']);
//print_r($_POST);
//lanjut ke cetak

echo "
<script>
	window.location='cetak.php?s=".$sk."&id=".$_POST['nobuku']."';
</script>
";
