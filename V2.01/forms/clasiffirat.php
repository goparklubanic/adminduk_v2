...
<div class="form-group" <?php echo $ds;?> >
	...
	<div class='col-sm-9'>
		<?php include "nomorAgenda.php"; ?>
		<span class='col-sm-2'><input type='text' class='form-control' name='nobuku' value=""/></span>
		<span class='col-sm-6'>/<?php echo kopkelur.'/'.date('Y'); ?></span>
	</div>
</div>
