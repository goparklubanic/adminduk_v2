...
<div class="container">
-->	
	<form role="form" action="surat-sve.php?sk=ush" method="post">
		...
		<div class="form-group">
			<label for="jnusaha">Jenis Usaha</label>
			<input type="text" class="form-control" id="jnusaha" name="jnusaha">
		</div>
		<div class="form-group">
			<label for="jnbarang">Jenis Barang Dagangan</label>
			<input type="text" class="form-control" id="jnbarang" name="jnbarang">
		</div>
		<div class="form-group">
			<label for="mulaius">Memulai usaha sejak</label>
